...
export async function onRequestPost({ request, env }) {
  ...
  if (!raw) {
    // Don't reveal whether the gallery exists.
  ...
  // Merge with any existing authorized galleries on the current cookie.
  ...
  return json(
    ...
    { headers: { 'Set-Cookie': cookieHeader('media_auth', cookieValue, SESSION_MAX_AGE) } }
  );
}
